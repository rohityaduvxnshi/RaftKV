...
const file_raft_proto_rawDesc = "" +
	"\n" +
	"\n" +
	"raft.proto\x12\x06raftpb\"c\n" +
	"\bLogEntry\x12\x12\n" +
	"\x04term\x18\x01 \x01(\x04R\x04term\x12\x14\n" +
	"\x05index\x18\x02 \x01(\x04R\x05index\x12\x18\n" +
	"\acommand\x18\x03 \x01(\fR\acommand\x12\x13\n" +
	"\x05no_op\x18\x04 \x01(\bR\x04noOp\"\x95\x01\n" +
	...
	"\x0fInstallSnapshot\x12\x1e.raftpb.InstallSnapshotRequest\x1a\x1f.raftpb.InstallSnapshotResponseBHZFgithub.com/rohityaduvxnshi/RaftKV/internal/transport/grpc/proto;raftpbb\x06proto3"
